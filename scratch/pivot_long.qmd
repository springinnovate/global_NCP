...
out_rds <- file.path(cfg$paths$processed_data_dir, "plt_long.rds")
dir.create(dirname(out_rds), recursive = TRUE, showWarnings = FALSE)
message("Saving plt_long.rds to: ", normalizePath(out_rds))
saveRDS(plt_long, out_rds)
message("Finished writing ", out_rds)

if (requireNamespace("arrow", quietly = TRUE)) {
  out_feather <- file.path(cfg$paths$processed_data_dir, "plt_long.feather")
  arrow::write_feather(plt_long, out_feather)
  message("Finished writing ", out_feather)
}
```
