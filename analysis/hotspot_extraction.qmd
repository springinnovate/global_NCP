...
services_clean <- stringr::str_remove(services_raw, service_suffix_pattern)
...
col_map <- tibble::tibble(
  ...
  dplyr::mutate(service_norm = stringr::str_remove(base, "_(mean|sum)$")) |>
...
plt_long <- sf_f |>
  ...
  dplyr::mutate(service = stringr::str_remove(service, "_(mean|sum)$")) |>
