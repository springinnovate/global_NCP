...
3. **Spatial clustering & overlap** – `analysis/hotspot_synthesis.qmd`
   Consumes `plt_long` and canonical geometries to calculate hotspot intensity (coverage), enrichment, and multi-service "hotness". Exports summary tables and clustering plots.
