...
format:
  revealjs:
    ...
    height: 800
    margin: 0.08
    footer: "WWF Global Science | 12 agosto 2026"
...
En el marco de su aprticviapción en la alizanza Natural Capital en Global Science- WWF  tenemos modelamos servicios ecosistémicos a nivel mundial — tanto donde son **más críticos de proteger o restaurar (oportunidad)**, como donde están **en declive (riesgo)**:

- Pipeline **reproducible y multi-servicio**, a a partir de InVEST a 300m de resolución nativa, agregado a una grilla global de 10km, 1992–2020.
- Aplicado a escala global y regional (América Latina y el Caribe) — se puede aplicar a casos específicos ( ej. **Colombia**).
- Arquitectura reutilizable a nivel de país, regional/subregional u otras unidades de priorización.

::: {style="text-align: right; margin-top: 14px;"}
![](invest_logo.png){style="height:80px; width:auto;"}
:::
...
:::
::: {.column width="45%"}
![](../../outputs/plots/colombia_report/colombia_biome_relative_intensity_focus.png){style="max-height:620px; width:auto; max-width:100%;"}
:::
:::
