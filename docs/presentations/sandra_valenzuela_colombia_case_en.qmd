...
::: {style="text-align:center;"}
![](../../docs/reports/colombia_clec/colombia_change_5panel.png){style="height:620px; width:auto; max-width:1188px;"}
:::
...
If asked about the reference biome map (not included on this slide for space): it's in the full report, `docs/reports/colombia_clec/colombia_clec_report.qmd`.
:::
