...
Use the adjusted Griscom restoration data (deals with pixel values encoding issues in the original data, had to get the metadadata for that). 
...
## 3.1 Load Intervention Data back

```{r load intevention data}
tiffes <- file.path(here("restoration_combined"), list.files(paste0(here("restoration_combined")),pattern= 'ES'))
