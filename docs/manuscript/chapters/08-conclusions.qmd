...
- **Attribution gap** (~76%): The majority of hotspot cells show no detectable categorical land-cover transition at 300m resolution — plausible mechanisms include sub-pixel degradation, upstream routing cascades, and climate forcing, but this analysis identifies spatial co-occurrence, not causal attribution
...
3. **Attribution analysis as co-occurrence**: ~76% of hotspot cells show no detectable LCC transition; this identifies spatial co-occurrence, not causal attribution — the endogeneity of ESA CCI as both an InVEST input and attribution overlay means the gap is a structured signal, not an independent empirical partition
...
- **Why** services are declining (conversion co-occurs with 24%; a 76% attribution gap signals mechanisms operating below detection thresholds)
