...
::: {style="text-align:center;"}
![](../../outputs/plots/colombia_report/global_change_5panel_es.png){style="height:504px; width:auto; max-width:1260px;"}
:::
...
<div class="stat-row">
  <div class="stat-callout accent">
    ...
    <span class="stat-label">de las celdas dentro de mi propia área de estudio (Piedmont/Altillanura) son hotspots de cambio — casi el doble del 12,5% nacional</span>
  </div>
</div>
```
:::
...
::: {.notes}
Cierre — esta es la diapositiva del "ask," y se dejó deliberadamente liviana (reencuadrada 2026-08-20 a pedido explícito): el resto del deck ya construyó el caso, esta diapositiva es un gancho para que la conversación fluya, no un segundo argumento escrito. No sobre-especificar el cronograma; dejar que Sandra defina el ritmo de la conversación.

Puntos para desarrollar en voz alta, no en el slide:
- **Oferta personal**: con el tiempo adecuado, un corte Colombia-nacional a mayor detalle — Llanos/Orinoquía, transición amazónica, páramos que abastecen a Bogotá — con la misma metodología estandarizada, leído a través de mi propia investigación doctoral sobre frontera agrícola (accesibilidad e idoneidad del suelo) en el Piedmont/Altillanura de la Orinoquía.
- **Oferta institucional**: más allá de ese corte, el mismo pipeline puede sostener reportería continua para WWF Colombia — beneficiarios, superposición con activos naturales críticos, servicios en declive — enfocada en la huella de su hoja de ruta de conservación liderada localmente. Viene directamente de la reunión interna con Becky: el complemento institucional a la oferta personal — no depende de una sola persona.

El punto de la investigación doctoral propia en la Orinoquía es lo que diferencia esta oferta de "otro consultor con un mapa" — es una combinación poco común de modelación biofísica global y experiencia directa con cambio de cobertura en la frontera agrícola de la región.
