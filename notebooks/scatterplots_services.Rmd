...
Load the input ecosystem service data for the final prioritized Ecosystem Service Change Data */output_data/metrics_change_hb_lev_6.csv* 
...
# ---------------------------------------------------------
# STEP 1: Filter by Basin Area (SUB_AREA)
# ---------------------------------------------------------

# ---- USER OPTIONS ----
filter_type <- "percent"       # Options: "quantile", "percent", "absolute"
filter_cutoff <- 0.05          # E.g., 0.05 = 5% cutoff
filter_direction <- "tail"     # Options: "top", "bottom", "both", "tail", "middle", "none"
# -----------------------
