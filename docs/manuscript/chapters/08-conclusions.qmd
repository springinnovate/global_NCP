...
- **Conversion-detectable decline** (~24%): Land cover change co-occurs with roughly a quarter of hotspots
- **Attribution gap** (~76%): The majority of hotspot cells do not co-occur with extreme (top 5%) land cover conversion at 300m — those cells may still have moderate LCC below the threshold; plausible mechanisms for the gap include sub-pixel degradation, upstream routing cascades, and climate forcing, but this analysis identifies spatial co-occurrence, not causal attribution
- **Regional variation**: Tropics show higher conversion signature; developed regions show more degradation signals

**Actionable implication**: One-size-fits-all interventions won't work. Conversion-detectable hotspots need land protection; hotspots in the attribution gap require targeted investigation and likely a mix of management reform, restoration, and climate adaptation.
...
- **For attribution-gap hotspots** (no co-occurrence with extreme LCC): Restoration, sustainable land management, and investment in fine-scale monitoring to diagnose underlying mechanisms
...
2. **Attribution mechanisms**: What drives the 76% spatial gap? Disentangling sub-pixel degradation, upstream routing effects, and climate forcing requires controlled factorial experiments beyond this analysis's scope.
...
- **Why** services are declining (extreme land conversion co-occurs with 24% of hotspots; the 76% attribution gap signals ES declines not co-located with the most extreme categorical conversions)
...
3. **The 76% attribution gap is a structured signal, not a data failure.** Most hotspot cells do not co-occur with the most extreme (top 5%) land cover conversion. This could reflect sub-pixel degradation, upstream routing effects, or climate forcing — mechanisms this analysis identifies as plausible but cannot partition. The implication is that relying solely on categorical land conversion mapping will miss the majority of ES decline.
