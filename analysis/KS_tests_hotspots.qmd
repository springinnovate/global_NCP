...
| `auc` | Probability of superiority (AUC; equivalent to normalized Mann–Whitney U): P(value_hotspot > value_nonhotspot). 0.5 ⇒ no tendency; >0.5 ⇒ hotspots tend higher; <0.5 ⇒ hotspots tend lower. |
