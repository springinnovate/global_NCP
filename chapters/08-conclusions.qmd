...
- **~1 billion people** live in or depend on ecosystem service hotspots
- **Low-income populations** comprise X% of people affected (Y% of global population)
...
- **Equity gap**: Those least able to adapt bear the greatest burden
...
- **Conversion-driven decline** (X%): Land cover change explains majority of hotspots
- **Degradation-driven decline** (Y%): In-situ quality decline signals unexplained service loss
- **Regional variation**: Tropics show higher conversion signature; developed regions show more degradation signals
- **Attribution gap** remains: ~30-55% of decline unexplained, suggesting climate, fine-scale changes, or model limitations
