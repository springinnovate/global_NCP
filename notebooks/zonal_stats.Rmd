...
poly <- st_read(here('vector', 'global_poly_means.gpkg')) 
poly <- st_read('/Users/rodriguez/Library/CloudStorage/OneDrive-WorldWildlifeFund,Inc/global_NCP/vector/income_group.gpkg')
...
p_1992 <- plot_ecosystem_services(zonal_df, 1992, "name_long")
p_2020 <- plot_ecosystem_services(zonal_df, 2020, "name_long")
...
load(here("output_data", "diffs_global.RData"))
...
# Generate plots for different years using a specified column
p_diff <- plot_ecosystem_services1(zonal_df, "name_long")
