...
# 6. Consolidate the Grids 

We are going to have thrree basivc grid geopakages: 
-1. Two columns, grid fid + countrty fid
-2. The same but add the groupings

```{r organize/consolidate outputs with territories}
