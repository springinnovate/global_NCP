"""Factorial cell 4 of 4: her CN, our Kc. Mirror of `09f` with the opposite hybrid table. See
`09f`'s own docstring for the full rationale.
    ...
    MSYS_NO_PATHCONV=1 docker run --rm -w /scripts_root -e SWY_DATA_ROOT=/scripts_root/data \\
        ...
        /scripts_root/Python_scripts/swy_philippines_run/09g_run_swy_ph_herCN_ourKc.py
"""
import os
...
def main():
    ...
    workspace = os.path.join(DATA_ROOT, "swy/philippines/workspace_becky_inputs_90m_herCN_ourKc")
    ...
    args = {
        ...
        "results_suffix": "ph_becky_inputs_90m_herCN_ourKc",
        ...
        "et0_dir": et0_staging,
        # The one deliberate change: her CN, our Kc.
        "biophysical_table_path": os.path.join(
            inputs_sp, "ph_biophysical_table_herCN_ourKc.csv"
        ),
