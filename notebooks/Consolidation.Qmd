...
B_sums <- st_read("/Users/rodriguez/Library/CloudStorage/OneDrive-WorldWildlifeFund,Inc/global_NCP/output_data/archive/hydrosheds_lv6_synth_benef_sums.gpkg")
...
cp2 <- st_read(paste0(inpath,"/", "grid_10k_coastal.gpkg"))
...
# Already calculated
cp_calc <- st_read(paste0(inpath, '/', 'grid_10k_coastal_calc.gpkg'))
...
st_write(cp_calc, here("data_NCP", "vector",'grid_10k_coastal_risk_1992_2020.gpkg')) # not needed anymore. The calc already has the second fid
```
...
sf_f <- st_read(paste0(inpath,'/', '10k_grid_ES_change_benef-Cumaribo.gpkg'))
...
ly_c <- st_layers(paste0(inpath,'/', 'grid_10k_coastal_calc.gpkg'))
cp_calc <- st_read(paste0(inpath,'/', 'grid_10k_coastal_calc.gpkg'), layer = "Coastal_Protection")
...
st_write(cp_calc, paste0(inpath, '/', 'grid_10k_coastal_ch.gpkg'), append=FALSE)
...
st_write(sf_f, paste0(inpath, '/', '10k_grid_ES_change_benef_f.gpkg'), append=FALSE)
...
```
>>>>>>> 29a2da3 (Fixin fid coastal protection)
