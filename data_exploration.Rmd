...
baseES_v <- lapply(baseES_v, function(df) {
  ...
  col_name <- names(df)[1]
  # Create a new column "Service" with the first 10 characters of the colu
  df$Service <- substr(col_name, 1, 10)
  return(df)
})
...
write.csv(baseES_v, here('output_data', "distributionServ_pa1.csv"))
