...
basins <- st_read(here("vector", "Country_id.gpkg"))
basins <- basins[c(1,2)]
col <- "id"
# basins <- st_read(here("vector", "hydrosheds_lv6_synth.gpkg"))
# basi
# #if only the basic hydroshed columns.
...
lcc_m2 <- extract_lcc_metrics(landcover_rasters[[1]], landcover_rasters[[2]], basins, col, percent=TRUE, mc = TRUE, ncores = 4, digits = 3)
...
sf::st_write(basins, here("vector", "countries_lc2.gpkg"), layer = "1992_2020_lcc_change_metrics", append = FALSE)
