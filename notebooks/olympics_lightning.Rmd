...
poly <- st_transform(poly, crs=crs(bkg_ee))
griscom <- round(project(griscom, crs(bkg_ee), res=30, threads=24))
bkg_2 <- project(bkg_ee, baseES[[2]], threads=24)   # This is necessary if a large raster is to be masked. Easier to reproject the mask to the larger object. D'uh
bkg_ee <- mask(bkg_ee, poly) 
