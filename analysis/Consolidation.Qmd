...
#
# Note: the canonical dataset is intentionally a subset (selected services +
# selected beneficiary summaries + groupings). If you need more variables
# later, expand the keep lists below or use the full QA dataset as input.
  ...
  c(
    paste0(
      c(
        "fields_mehrabi_2017",
        "GHS_BUILT_S_E2020",
        "hdi_raster_predictions_2020",
        "rast_adm1_gini_disp_2020"
      ),
      "_mean"
    ),
    paste0(
...
message("Beneficiary columns kept (n = ", length(benef_keep), "):")
print(benef_keep)
