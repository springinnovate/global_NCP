...
This document provides a preliminary assessment of the  potential ecosystem service gains derived from 
restoration in the state of **Espírito Santo (Brazil)** 
## 1.1 Purpose
...
2.  Estimate potential ecosystem service (ES) provision gains if a targeted surface is restored in the region .
...
Espírito Santo State, Brazilian Atlantic coast.  
...
The input data used here is derived from global ecosystem service models, where the pixel value represent the estimated gain in units of the selected ecosystem services if the targeted surface is restored to a natural/seminatural state.
...
tiffes <- file.path(here("cropped_raster_data" ), list.files(paste0(here("cropped_raster_data")),pattern= "BRAZIL*\\.tif$"))
