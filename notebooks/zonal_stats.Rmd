...
poly <- st_read("/Users/rodriguez/Library/CloudStorage/OneDrive-WorldWildlifeFund,Inc/WWF_nbs_op/globalESLatin'/global_2024-05-08.gpkg") 
...
rasters_list <- lapply(raster_files, rast)

# Name each raster in the list for easy reference
names(rasters_list) <- c("Raster_1", "Raster_2", "Raster_3") 

Explanation:
  •	We specify a list of file paths to our GeoTIFFs.
•	terra::rast() reads each TIFF into a SpatRaster.
