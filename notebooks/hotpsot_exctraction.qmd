...
```{r scatterplot 3, lot,fig.height=7, fig.width=12, warning=FALSE}
...
hs_bins        <- 50     # number of bins for hotspots (can be lower)
bg_alpha       <- 0.85   # opacity for non-hotspot heatmap
...
# runner.R — execute the density overlay with your current settings
