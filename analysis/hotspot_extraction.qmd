...
lyr_sf <- st_layers("/home/jeronimo/OneDrive/global_NCP/data/processed/10k_change_calc.gpkg")
sf_f <- st_read("/home/jeronimo/OneDrive/global_NCP/data/processed/10k_change_calc.gpkg") 
...
hs <- extract_hotspots(
  ...
  write_sf_path = "output_data/hotspots3.gpkg",       
  write_driver  = "GPKG",                              
  clean_names   = TRUE,
