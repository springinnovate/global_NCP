...
```{r chunk 3, fig.height=8, fig.width=14}
...
<<<<<<< HEAD
```{r Sankey Diagram, eval=FALSE, include=FALSE}
=======
...
```{r ggplot 2020, eval=FALSE, fig.height=8, fig.width=14, include=FALSE}
...
<<<<<<< HEAD
```{r timeseries plot, eval=FALSE, include=FALSE}
=======
```{r eval=FALSE, include=FALSE}
>>>>>>> 98ad7a6 (visualizations)
...
```{r faceted plot stdev, eval=FALSE, fig.height=18, fig.width=18, include=FALSE}
...
```{r chartTS country filter, eval=FALSE, include=FALSE}
...
```{r faceted plot count, eval=FALSE, fig.height=18, fig.width=18, include=FALSE}
...
```{r ttt, eval=FALSE, include=FALSE}
library(dplyr)
library(ggplot2)
...
```{r plot chg2, eval=FALSE, fig.height=8, fig.width=14, include=FALSE}
...
```{r Sankey 2 Diagram, eval=FALSE, include=FALSE}
...
```{r create list of columns, eval=FALSE, include=FALSE}
