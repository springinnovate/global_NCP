...
## Enrich grid with regional attributes (countries & biomes)
...
Helper `run_hotspot_violins_by()` now lives in `R/hotspot_violins.R`, so we just call it from this report.
