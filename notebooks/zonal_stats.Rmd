...
poly <- st_read('/Users/rodriguez/Library/CloudStorage/OneDrive-WorldWildlifeFund,Inc/global_NCP/vector/global_poly_means.gpkg')
# Optional dissolve to group by different vaiables (region, income, etc)
...
# 3. Calcualte Differences (check with original) 
 ...
 Thishas been already done, no need to do again.
...
num.cores <- length(rast_list) # set as many cores as rastersd to be evaluated. I need to take al ook at thi, the processsing times does not seem to have improved 
