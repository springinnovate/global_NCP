...
# TODO: Normalize variable names EARLY in this pipeline.
# Currently, downstream scripts (hotspot_extraction.qmd) have to apply a second layer of renaming/normalization
# (e.g. tolower + recode) to match config. Ideally, sf_f should have canonical CamelCase names right here.
rename_list <- list(
  c(
    usle_1992_mean = "global_usle_marine_mod_ESA_1992_mean",
    usle_2020_mean = "global_usle_marine_mod_ESA_2020_mean",
