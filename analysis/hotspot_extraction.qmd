...
# Filter out Antarctica from the dataset as it contains no relevant data for this analysis
if ("continent" %in% names(sf_f)) {
  sf_f <- dplyr::filter(sf_f, continent != "Antarctica")
}
...
pivot_groupings <- c("income_grp","region_wb","continent","region_un","WWF_biome")
