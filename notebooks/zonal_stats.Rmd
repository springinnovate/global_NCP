...
num.cores <- length(rast_list) # set as many cores as rasters to be evaluated. I need to take a look at this, mclapply does  n ot seem to be improving performance as much as it should. In fact, for the differences, performance is quite poor.
...
save(zonal_df, file=here('output_data', 'zonal_df_wb.RData'))
