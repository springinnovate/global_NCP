...
A single declining service is a concern; multiple co-occurring declines in the same grid cell represent severe compound risk — communities that lose several services simultaneously face compounding adaptive challenges. We refer to the count of overlapping negative hotspots in a single 10km cell as its **Hotness**.
...
Beyond identifying *where* hotspots are, the boxplots below show how intense those changes are within each group. The spread of SPC values reveals whether hotspots in a region represent moderate or extreme functional shifts.

::: {.panel-tabset}

### By Income Group

![Volumetric services (N/Sed export, Pollination, Nature Access) — percentage hotspot magnitudes by Income Group.](../../../outputs/plots/boxplots_unified/income_grp/boxplots_volumetric_pct.png){width=100%}

![Coastal and ratio services — percentage hotspot magnitudes by Income Group.](../../../outputs/plots/boxplots_unified/income_grp/boxplots_coastal_pct.png){width=100%}

![](../../../outputs/plots/boxplots_unified/income_grp/boxplots_ratios_pct.png){width=100%}

### By World Bank Region

![Volumetric services — percentage hotspot magnitudes by World Bank Region.](../../../outputs/plots/boxplots_unified/region_wb/boxplots_volumetric_pct.png){width=100%}

![Coastal and ratio services — percentage hotspot magnitudes by World Bank Region.](../../../outputs/plots/boxplots_unified/region_wb/boxplots_coastal_pct.png){width=100%}

![](../../../outputs/plots/boxplots_unified/region_wb/boxplots_ratios_pct.png){width=100%}

### By WWF Biome

![Volumetric services — percentage hotspot magnitudes by WWF Biome.](../../../outputs/plots/boxplots_unified/WWF_biome/boxplots_volumetric_pct.png){width=100%}

![Coastal and ratio services — percentage hotspot magnitudes by WWF Biome.](../../../outputs/plots/boxplots_unified/WWF_biome/boxplots_coastal_pct.png){width=100%}

![](../../../outputs/plots/boxplots_unified/WWF_biome/boxplots_ratios_pct.png){width=100%}
