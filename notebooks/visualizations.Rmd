...
set <- sets[t]
# # load polygons
poly <- st_read(set, layer = "lcc_change_metrics") 
...
```{r load and reshape processed geometries}
...
plot_es_changes(plt, label_col = col, filter_type = "top_bottom", filter_val = 5)

# Top/bottom 5% per service
plot_es_changes(plt, label_col = col, filter_type = "quantile", filter_val = 0.05)
