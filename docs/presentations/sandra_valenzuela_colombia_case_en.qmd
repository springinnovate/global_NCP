...
- Global Science:
  ...
  - **NatCap TEEMs** (U. of Minnesota) — models integrating economics, trade, and ecosystem services; leads the methodology project to estimate **Global GEP** (Gross Ecosystem Product, the GDP equivalent for nature's value).
...
- Strongest concentration in the **coffee axis, the central Andes, and the Orinoquía foothills**.
...
## Who: reach extends to 3 out of every 4 Colombians {.smaller}
...
<div class="stat-row">
  <div class="stat-callout">
    ...
    <span class="stat-label">of Colombia's population within the reach zone</span>
  </div>
  <div class="stat-callout accent">
...
```
- Applying standardized buffers (**50km downstream** or **1 hour travel time**) to combined cross-category change hotspots, the reach zone covers that share of Colombia's population.
- The strictest level (4 or more of 5 services with simultaneous extreme change) reaches **35.5% — 17.9 million people**.
...
## A concrete example: road infrastructure {.smaller}

- Among the sectors where this prioritization applies, road infrastructure already has a direct link: **Sediment export** — one of the two services with the highest concentration of change hotspots in Colombia — is directly related to erosion and runoff induced by road construction.
- The logic of avoiding harm from the planning stage onward aligns with the **Green Road Infrastructure Guidelines (LIVV)** — a Colombian interministerial policy (Mintransporte, Minambiente, ANI, INVIAS, DNP) with technical support from WWF Colombia and FCDS.
- This evidence layer can function as a standardized, repeatable risk signal for early-stage corridor selection — it doesn't replace the LIVV's fieldwork, it precedes it.

::: {.notes}
This is the slide that turns the technical finding into a value proposition specifically for WWF Colombia — important to be precise: the LIVV is a national policy led by Mintransporte, not a WWF document; WWF's role (together with FCDS) was technical support. The pitch isn't "replace your process" but "here's a standardized evidence layer that can feed into the earliest stage of that process, before field teams get involved" — and WWF Colombia already has an established technical relationship with that policy, which is the natural entry point.
...
Today, Colombia exists only within the aggregated Latin America and Caribbean regional total — this is the first cut with a specifically Colombian focus.

**The concrete offer**: with the right amount of time, we can produce a Colombia-national cut of the priority analysis (critical assets ∩ change hotspots) at finer detail — the Llanos/Orinoquía, the Amazon transition zone, the páramos that supply Bogotá — using the same standardized methodology, and read through an agricultural-frontier-dynamics lens grounded in my own doctoral research on land cover and land-use change in the Colombian Altillanura/Orinoquía, currently in preparation for publication.

Beyond this specific cut, the same pipeline can support **ongoing reporting for WWF Colombia** — recurring beneficiary reports, overlap with critical natural assets, and services in decline — focused specifically on the footprint of activities in its locally-led conservation roadmap.

::: {.notes}
Closing — this is the "ask" slide. Don't over-specify the timeline; let Sandra set the pace of the conversation. The point about my own doctoral research in the Orinoquía is what differentiates this offer from "another consultant with a map" — it's an uncommon combination of global biophysical modeling and direct experience with land-cover change on the region's agricultural frontier.

If asked for more detail on this research: PhD in Geography (Temple University, defended 2025), random-forest land-cover classification, multi-temporal change trajectories, and Olofsson-style accuracy assessment, focused on agricultural expansion dynamics (oil palm, cattle ranching) in the Altillanura. The chapter on frontier dynamics is in preparation for submission — don't mention specific figures yet, the analysis isn't in final form.

The second paragraph (ongoing reporting) comes directly from today's internal meeting with Becky — she sees it as the institutional complement to the personal offer above: not just "I can go deeper on this analysis," but "the WWF Global Science team can sustain recurring reports aligned with WWF Colombia's conservation agenda." The two reinforce each other: the personal offer demonstrates specific technical capability; the institutional offer demonstrates that it doesn't depend on one person.
