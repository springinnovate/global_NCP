...
tiffes <- tiffes[-c(1:5)] # removethe access becasue fucking distances. Deal with this when we´re done with the first one. We need to resample becasue of the pixel resolution. That´s annoying. just get the first ones done,then we deal with that one 
