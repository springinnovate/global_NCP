...
> **Note:** The hydrological basin structure has proven to be a promising spatial unit for ecosystem service analysis, providing consistency across scales and enabling meaningful aggregation for regional and global assessments.
...
zonal_wide <- pivot_wider(zonal_df, id_cols=c(col), names_from=c(year, service), values_from = c(sum, mean, stdev))
library(dplyr)
