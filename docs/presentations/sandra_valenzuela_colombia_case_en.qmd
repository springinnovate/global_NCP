...
::: {style="text-align:center;"}
![](../../outputs/plots/colombia_report/global_change_5panel_en.png){style="height:504px; width:auto; max-width:1260px;"}
:::
...
<div class="stat-row">
  <div class="stat-callout accent">
    ...
    <span class="stat-label">of cells within my own study area (Piedmont/Altillanura) are change hotspots — nearly double the 12.5% national rate</span>
  </div>
</div>
```
:::
::: {.column width="45%"}
![](../../outputs/plots/colombia_report/colombia_hotspot_map.png){style="max-height:480px; width:auto; max-width:100%;"}

::: {style="text-align:center; font-size:0.55em; color:#666; margin-top:-8px;"}
...
::: {.notes}
Closing — this is the "ask" slide, and it was deliberately kept light (reframed 2026-08-20 per explicit request): the rest of the deck already built the case, this slide is a hook for the conversation to flow from, not a second written argument. Don't over-specify the timeline; let Sandra set the pace of the conversation.

Points to develop out loud, not on the slide:
- **Personal offer**: with the right amount of time, a Colombia-national cut at finer detail — the Llanos/Orinoquía, the Amazon transition zone, the páramos that supply Bogotá — using the same standardized methodology, read through my own doctoral research on agricultural-frontier dynamics (accessibility and land suitability) in the Orinoquía's Piedmont/Altillanura.
- **Institutional offer**: beyond that cut, the same pipeline can support ongoing reporting for WWF Colombia — beneficiaries, overlap with critical natural assets, services in decline — focused on the footprint of its locally-led conservation roadmap. Comes directly from today's internal meeting with Becky: the institutional complement to the personal offer — doesn't depend on one person.

The point about my own doctoral research in the Orinoquía is what differentiates this offer from "another consultant with a map" — it's an uncommon combination of global biophysical modeling and direct experience with land-cover change on the region's agricultural frontier.
