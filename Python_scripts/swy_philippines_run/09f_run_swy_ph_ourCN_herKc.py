"""Factorial cell 3 of 4: our CN, her Kc. Everything else identical to `09e` (grid-snapped DEM,
real WWF-SIPA rain events, soil group, precip/ET0) -- only `biophysical_table_path` changes, to
isolate how much of the QF/B gap traces to CN specifically vs. Kc specifically. The other two
cells (her CN + her Kc = her own baseline; our CN + our Kc = `workspace_becky_inputs_90m_snapped`)
already exist, no rebuild needed.
    ...
    MSYS_NO_PATHCONV=1 docker run --rm -w /scripts_root -e SWY_DATA_ROOT=/scripts_root/data \\
        ...
        /scripts_root/Python_scripts/swy_philippines_run/09f_run_swy_ph_ourCN_herKc.py
"""
import os
...
def main():
    ...
    workspace = os.path.join(DATA_ROOT, "swy/philippines/workspace_becky_inputs_90m_ourCN_herKc")
    ...
    args = {
        ...
        "results_suffix": "ph_becky_inputs_90m_ourCN_herKc",
        ...
        "et0_dir": et0_staging,
        # The one deliberate change: our CN, her Kc.
        "biophysical_table_path": os.path.join(
            inputs_sp, "ph_biophysical_table_ourCN_herKc.csv"
        ),
