...
gmsk <- subst(griscom, from =0, to = NA)
...
```{r get summaries baseline, eval=FALSE, include=FALSE}
...
save(final_results, file= here("Interventions", "Mex_intervention", "all_res_mex2.RData"))
