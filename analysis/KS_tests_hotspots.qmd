...
KS_CFG <- list(
  ...
  # outputs
  out_table  = file.path(cfg$paths$processed_data_dir, paste0("ks_results_hot_vs_non", params$output_suffix, ".csv")),
...
rds_path <- file.path(cfg$paths$processed_data_dir, params$input_plt_long)
need_reload <- TRUE
