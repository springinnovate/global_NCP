...
To assess whether monitoring land cover change alone is sufficient to track where ES provision is declining most, we integrated Land Cover Change (LCC) metrics derived from ESA CCI and C3S land cover products (see Chapter 2 — Attribution Analysis: Land Cover Change Methodology for data sources, reclassification scheme, and the diffeR co-occurrence framework). In brief, we performed a spatial overlay between the finalized ecosystem service hotspot grids and five LCC driver layers — Forest Loss, Crop Expansion, Urban Expansion, Grassland Gain, and Grassland Loss — at 300-meter resolution.
