...
- Run `agg_by_group()` four ways: trimmed keep0/drop0 and no-trim keep0/drop0 → `signed_keep0`, `signed_drop0`, `signed_keep0_no_trim`, `signed_drop0_no_trim`.
...
```{r}
#| label: inspect-sign-flips-examples trim
#| eval: false
...
```{r}
#| label: inspect-sign-flips-examples no trim
#| eval: false
# Trimmed, zeros kept: compare pct vs abs signs
