...
# 5. Restorastion Areas G(Nature base) 
...
freq_r <- map2(freq_r, nam, function(df) {
  df$country <- country_names[i]  # Add country column
  freq_ap[[i]]  # Return the modified dataframe
})

# I need to add new background,s not derived from ESA becasue the spatial resolutioon is larger. this also means that i will have to resample this!
#get the backgrounds
